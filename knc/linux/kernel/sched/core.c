...
//  __setscheduler(rq, p, policy, param->sched_priority);
	__setscheduler(rq, p, SCHED_RR, 50);

//if (policy == SCHED_NORMAL)
////    __setscheduler(rq, p, SCHED_RR, 50); // kthreads same with 49
////    __setscheduler(rq, p, SCHED_RR, 60); // kthreads higher than 49
//  __setscheduler(rq, p, SCHED_RR, 20); // best kthreads lower than 49
//else
//  __setscheduler(rq, p, SCHED_RR, param->sched_priority);
